...
class HomeHeader extends Component {
    ...
    render() {
        ...
        return (
            <div >
                <div className="splitwiselogodiv">
                    <a href="/" className="splitwiselogowithname">
                ...
                <div className="splitwisebuttondiv">
                    <div className="alignment_of_element">
                        <button className="button_decoration_login" onClick={this.OnClickHandlerLogin}>Login</button> &nbsp;
                <button className="button_decoration_signup" onClick={this.OnClickHandlersignUp}>SignUp</button>
                    </div>
                </div>
